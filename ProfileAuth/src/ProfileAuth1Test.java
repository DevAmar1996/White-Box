...
class ProfileAuth1Test {

	
	 private ProfileAuth1 profileAuth1;
		
	@BeforeEach
	void setup() {
	    	profileAuth1 = new ProfileAuth1();
	}
		
	@Test
	void test1() {
		ArrayList<Profile> profiles = new ArrayList<Profile>();
		Account account = new Account(null,profiles);
		profileAuth1.profilePasscode(account, "1212", 0);
	...
	void test2() {
		...
		Account account = new Account("User1",profiles);
		for(int i = 0 ; i < 3; i ++) {
			profileAuth1.profilePasscode(account, "1212", 1);
		}
	...
	void test6() {
		...
		profileAuth1.profilePasscode(account, "1234", 1);
